...
import { TrendingUp, TrendingDown, MessageSquare, MessagesSquare, Megaphone, Clock, RefreshCw, Download, Sun, AlertCircle, UserPlus, PhoneCall, IndianRupee, FileText, Receipt } from 'lucide-react';
        ...
        return (
          <div className="bg-card rounded-xl border border-border p-4 sm:p-5">
            <div className="flex items-center gap-2 mb-4">
              ...
              <button onClick={() => navigate('/reminders')} className="text-xs text-primary hover:underline ml-auto">View all</button>
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              {[
